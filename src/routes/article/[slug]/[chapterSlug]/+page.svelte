<script lang="ts">
  ...
  import ChapterMenuMobile from './ChapterMenuMobile.svelte';
...
<section class="py-8 relative">
  <div class="container mx-auto px-4">
    <div class="flex flex-col lg:flex-row gap-8 relative">
      ...
      <ChapterMenu {chapters} {slug} {chapterSlug} {chapterIndex} {meta} />
      <ChapterMenuMobile {chapters} {slug} {chapterSlug} {chapterIndex} {meta} />
