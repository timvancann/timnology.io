...
`}
  ...
  >
    <div class="font-medium" class:text-[#00BBBB]={activeChapter === null}>Article Overview</div>
  </a>
  ...
  {#each chapters as chapter, i (i)}
    ...
    >
      ...
      <div
        class={`absolute top-3 right-3 flex items-center justify-center w-6 h-6 rounded-full bg-[#131836] border border-white/10 text-xs font-medium text-slate-300 transition-all duration-300 group-hover:bg-[#00BBBB]/10 group-hover:border-[#00BBBB]/30
